...
fig = plt.figure()
fig.suptitle('Test set 2',fontsize=20)
ax1 = fig.add_subplot(321)

ax1.plot(np.transpose(jp_origins[10:,0]),'r-',label='origin')
...
ax2.plot(np.transpose(jp_origins[10:,1]),'r-',label='origin')
...
ax3.plot(np.transpose(jp_origins[10:,2]),'r-',label='origin')
...
ax4.plot(np.transpose(jp_origins[10:,3]),'r-',label='origin')
...
ax5.plot(np.transpose(jp_origins[10:,4]),'r-',label='origin')
...
ax6.plot(np.transpose(jp_origins[10:,5]),'r-',label='origin')

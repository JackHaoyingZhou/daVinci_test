...
for i in range(5):
    jp0_list = jp_0 + gauss(-.05, .05)
    jp1_list = jp_1 + gauss(-.05, .05)
    jp2_list = jp_2 + gauss(-.05, .05)
    jp3_list = jp_3 + gauss(-.05, .05)
    jp4_list = jp_4 + gauss(-.05, .05)
    jp5_list = jp_5 + gauss(-.05, .05)
    jp0.append(jp0_list)
    jp1.append(jp1_list)
    jp2.append(jp2_list)
    jp3.append(jp3_list)

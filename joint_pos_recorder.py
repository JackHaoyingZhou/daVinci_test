...
class JointPosRecorder():
    def __init__(self, save_path = '.', record_size = 200):
    ...
    def record(self, joint_pos):
        ...
        queue_item = {'time':utc_timestamp, 'pos':joint_pos}
...
class JointPosLoader():
    ...
    @staticmethod
    def load_range(folder_path = '.', datetime_str = None):
        ...
        jp_list = glob(os.path.join(folder_path, '*.jplist'))
...
if __name__ == '__main__':
    ...
    if choice == 1:
        ...
        m,l = JointPosLoader.load_by_prefix('JP#2021-05-06 21:23')
        pprint(m)
    elif choice == 5:
        import random
        recorder = JointPosRecorder()
